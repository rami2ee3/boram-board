...
<body>
<div class="card">
    <b class="card-header">${detail.baTitle}</b>
    <span class="card-header">작성일자 : <fmt:formatDate value="${detail.baInsertDt}" pattern="yyyy.MM.dd"/></span>
    <div class="card-body">
...
<form id="frmBoard" name="frmBoard" method="GET">
    <input type="hidden" id="frmBoardBaId" name="baId" value="${detail.baId}">
